...
def load_dataset_embeddings(dataset_name, path,
                            matdata_file='res101.mat', matattrsplit_file='att_splits.mat'):
    ...
    if dataset_name not in valid_datasets:
        raise ValueError(
            'Unknown dataset! This script is aimed on {} datasets'.format(valid_datasets))
...
if __name__ == "__main__":
    ...
    save_data(embeddings, labels, splits_df,
              dataset_name=args.dataset, save_dir=args.output_dir)
