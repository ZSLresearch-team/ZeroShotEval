...
#from zeroshoteval.proc.evaluation.lisgan_classifier import classification_procedure
...
def experiment(cfg):
    ...
    acc_seen_hist, acc_unseen_hist, acc_H_hist = classification_procedure(cfg=cfg,
    data = zsl_emb_dataset,
    in_features = zsl_emb_dataset.tensors[0].shape[1],
